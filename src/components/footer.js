      ...
      <div style={{color: 'white', textAlign: 'center', position: 'absolute', bottom: 0, left: 0, zIndex: 10, height: '4em', width: '100%', paddingTop: '0.5em', paddingBottom: '0.5em', backgroundColor: '#4476b2'}}>
        ...
        <MediaQuery query='(min-device-width: 1224px)'>
          <div style={{display: 'inlineBlock', float: 'left', fontSize: '0.7em', width: '(100/3)%', textAlign: 'left', paddingLeft: '5vw'}}>
            <p style={{fontFamily: 'Roboto', fontWeight: 100, margin: 0}}>Office Hours: 8:00 am to 6:00 pm PT (weekdays)</p>
            <p style={{fontFamily: 'Roboto', fontWeight: 100, margin: 0}}>Mail: P.O. Box 12345, Seattle, WA 98145</p>
            <p style={{fontFamily: 'Roboto', fontWeight: 100, margin: 0}}>Phone: (206) 425-3600</p>
            <p style={{fontFamily: 'Roboto', fontWeight: 100, margin: 0}}>Fax: (206) 354-3545</p>
          </div>
        </MediaQuery>
        <MediaQuery query='(min-device-width: 1224px)'>
          <div style={{width: '(100/3)%', display: 'inlineBlock', float: 'right', textAlign: 'center', paddingTop: '0.5em'}}>
            ...
            <a href='mailto:leasing@apartment.com'>
