  ...
  render(){
    return (
      <div style={{height: '100vh', overflow: 'hidden', width: 'auto', backgroundImage: 'radial-gradient(circle, rgb(182, 202, 222), rgb(51,87,129)'}}>
        ...
        <MuiThemeProvider>
          <RaisedButton href="/manager" label="Welcome" buttonStyle={{fontWeight: 'bold', backgroundColor: 'rgb(255, 255, 255)', position: 'fixed', top: '70%', left: '50%', transform: 'translate(-50%, -50%)', width: 'auto'}}/>
        </MuiThemeProvider>
      </div>
    );
  }
